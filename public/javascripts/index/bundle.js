...
function moveInClient(myPlayerObj, flyingMissilesMap) {
    ...
    try {
        for (var _iterator = flyingMissilesMap[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var _ref = _step.value;

            var _ref2 = _slicedToArray(_ref, 2);

            var missileId = _ref2[0];
            var flyingMissile = _ref2[1];
...
function drawRanking(ctxScore, playersMap) {
    var playersArray = [].concat(Array.from(playersMap)); //連想配列でソートが出来ないためArrayにする
    ...
    */
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var rank = i + 1;
        ctxScore.fillText(rank + '\u4F4D ' + playersArray[i][1].displayName + ' ' + playersArray[i][1].score, 10, 220 + rank * 26);
    }
}
...
socket.on('map data', function (compressed) {
    ...
    try {
        for (var _iterator2 = playersArray[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var compressedPlayerData = _step2.value;
...
function drawMap(gameObj) {
    ...
    try {
        for (var _iterator3 = gameObj.playersMap[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            ...
            if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2) {
                ...
                var degreeDiff = calcDegreeDiffFromRader(gameObj.deg, distanceObj.degree);
    ...
    try {
        for (var _iterator4 = gameObj.itemsMap[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            ...
            if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2) {
                ...
                var _degreeDiff = calcDegreeDiffFromRader(gameObj.deg, distanceObj.degree);
                var _toumeido = calcOpacity(_degreeDiff);

                gameObj.ctxRader.fillStyle = 'rgb(255, 165, 0, ' + _toumeido + ')';
                gameObj.ctxRader.beginPath();
    ...
    try {
        for (var _iterator5 = gameObj.airMap[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2) {
                ...
                var _degreeDiff2 = calcDegreeDiffFromRader(gameObj.deg, distanceObj.degree);
        ...
        for (var _iterator6 = gameObj.flyingMissilesMap[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
            ...
            if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 + 50 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2 + 50) {
                ...
                if (flyingMissile.emitPlayerId === gameObj.myPlayerObj.playerId) {
                    ...
                    var _degreeDiff3 = calcDegreeDiffFromRader(gameObj.deg, distanceObj.degree);
